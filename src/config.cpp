...
static constexpr char default_psv_games_url[] = "http://pkgj.dragonfly.fun/tsv/titles_psvgames.tsv";
static constexpr char default_psv_dlcs_url[] = "http://pkgj.dragonfly.fun/tsv/titles_psvdlcs.tsv";
static constexpr char default_psv_demos_url[] = "http://pkgj.dragonfly.fun/tsv/titles_psvdemos.tsv";
static constexpr char default_psv_themes_url[] = "http://pkgj.dragonfly.fun/tsv/titles_psvthemes.tsv";
static constexpr char default_psx_games_url[] = "http://pkgj.dragonfly.fun/tsv/titles_psxgames.tsv";
static constexpr char default_psp_games_url[] = "http://pkgj.dragonfly.fun/tsv/titles_pspgames.tsv";
static constexpr char default_psp_dlcs_url[] = "http://pkgj.dragonfly.fun/tsv/titles_pspdlcs.tsv";
static constexpr char default_psm_games_url[] = "http://pkgj.dragonfly.fun/tsv/titles_psmgames.tsv";
